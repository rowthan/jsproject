...
var keyUp = function keyUp(e) {
  var str = document.getElementById("test").value.substr(0,1);
  var start = 0;
  var check = 1;


    // if (check&&str) {
    //   var pop = str.substr(start,start+1)
    //    letterpushed = true;
    //    var ltr = generateLetter(str);//String.fromCharCode(e.keyCode)
    //    letterlist.push(ltr);
    //    start++;
    // }
